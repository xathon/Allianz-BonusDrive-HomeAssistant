"""Binary sensor platform for bonusdrive."""
...
class BonusdriveBinarySensor(BonusdriveEntity, BinarySensorEntity):
    """bonusdrive binary_sensor class."""
